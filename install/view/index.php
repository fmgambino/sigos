...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo $dashboard_url; ?>install/assets/images/faviconEG.ico" type="image/x-icon" />
  ...
  <div class="install-box">
    <div class="panel panel-install">
      ...
      <div class="panel-heading text-center">
        <img id="logo" class="card-img-top" src="<?php echo $dashboard_url; ?>assets/img/logoEG.png" title="Logo" />
